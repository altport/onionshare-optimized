# OnionShare-Optimized Desktop

## Building OnionShare-Optimized
...
cd onionshare-optimized/desktop
```
...
### Running OnionShare-Optimized from the source code tree

Inside the virtual environment, run OnionShare-Optimized like this to install all of the dependencies:
